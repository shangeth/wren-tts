...
def main():
    ...
    parser.add_argument("--repo_id",        default="shangeth/Wren-TTS-0.5B-multi-expressive",
                        help="<user_or_org>/<model_name>")
    parser.add_argument("--checkpoint",     default="checkpoints/expressive/best.pt")
    parser.add_argument("--private",        action="store_true")
    parser.add_argument("--commit_message", default="Upload Wren-TTS-0.5B-multi-expressive checkpoint")
