"""
Push the Wren-TTS-0.5B-multi Gradio Space to the Hugging Face Hub.

Uploads the full hf/multi/space/ folder (app.py, README.md, requirements.txt,
...
Usage:
  ...
  python hf/multi/push_space.py                                # default Space repo
...
def main():
    ...
    parser.add_argument("--commit_message", default="Update Wren-TTS-0.5B-multi Gradio demo")
